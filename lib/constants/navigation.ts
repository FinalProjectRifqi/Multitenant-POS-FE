...
export const ROLE_NAV: Record<RoleCode, NavItem[]> = {
  [ROLE_CODE.MANAJEMEN_GRUP]: [
    ...
    { label: "Kelola Inventaris", href: "/group/inventaris",  icon: "PackageSearch" },
    { label: "Kelola Pengguna",   href: "/group/pengguna",    icon: "Users" },
    { label: "Riwayat Transaksi", href: "/group/transaksi",   icon: "ClipboardList" },
  ],
  ...
  [ROLE_CODE.MANAJER_UNIT]: [
    ...
    { label: "Kelola Inventaris", href: "/unit/inventaris",   icon: "PackageSearch" },
    { label: "Riwayat Transaksi", href: "/unit/transaksi",    icon: "ClipboardList" },
  ],

  [ROLE_CODE.STAF_UNIT]: [
    { label: "Kelola Pesanan",    href: "/unit/pos",          icon: "ShoppingCart" },
    { label: "Riwayat Transaksi", href: "/unit/transaksi",    icon: "ClipboardList" },
    { label: "Proses Pembayaran", href: "/unit/pembayaran",   icon: "CreditCard" },
  ],
};
